...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 74, $this->source)))) : (""))];
  ...
  <header class=\"";
    ...
    ";
        ...
        // line 99
        yield "  </header>
  PEPITOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
  <div";
        // line 101
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["node__content", ($context["layout"] ?? null)], "method", false, false, true, 101), 101, $this->source), "html", null, true);
        yield ">
    ";
        // line 103
        yield "    ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["content"] ?? null), 103, $this->source), "comment"), "html", null, true);
        yield "
  </div>
  ";
        // line 105
        if (CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "comment", [], "any", false, false, true, 105)) {
            // line 106
            yield "    <div id=\"comments\" class=\"";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["layout"] ?? null), 106, $this->source), "html", null, true);
            yield "\">
      ";
            // line 107
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "comment", [], "any", false, false, true, 107), 107, $this->source), "html", null, true);
            yield "
    </div>
  ";
        }
...
";
    ...
    {
        return array (  160 => 110,  154 => 107,  149 => 106,  147 => 105,  141 => 103,  137 => 101,  133 => 99,  127 => 96,  114 => 94,  109 => 93,  103 => 90,  100 => 89,  98 => 88,  95 => 87,  93 => 86,  88 => 85,  80 => 82,  75 => 81,  73 => 80,  69 => 79,  65 => 78,  60 => 77,  58 => 74,  57 => 73,  56 => 72,  55 => 71,  54 => 70,  53 => 69,  52 => 67,  49 => 65,  47 => 64,  44 => 63,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 64, "escape" => 77, "t" => 94, "spaceless" => 94, "without" => 103);
